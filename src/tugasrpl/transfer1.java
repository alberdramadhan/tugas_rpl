...
public transfer1() {
     ...
     private void transaksi(){
        ...
        try {
            int no=1;
            String sql = "select * from bayar_makanan";
    ...
    private void initComponents() {
        ...
        idmakanan = new javax.swing.JTextPane();
        jScrollPane7 = new javax.swing.JScrollPane();
        namamakanan = new javax.swing.JTextPane();
    ...
    JOptionPane.showMessageDialog(rootPane,"Saldo Anda Saat Ini adalah :"+ saldo);
        try {
            String sql = "INSERT INTO bayar_makanan VALUES ('"+idmakanan.getText()+"','"+namamakanan.getText()+"','"+totalbayar.getText()+"','"+namatoko.getText()+"','"+jenistoko.getSelectedItem()+"','"+nohp.getText()+"')";
            java.sql.Connection conn=(Connection)config.configDB();
    ...
    private void tes1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tes1MouseClicked
        ...
        idmakanan.setText(id_barang);
        String nama_barang = tes1.getValueAt(baris,2).toString();
        namamakanan.setText(nama_barang);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            String sql ="SELECT * from bayar_makanan where id_makanan='"+idmakanan.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
        } catch (Exception e) {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {
            String sql ="delete from bayar_makanan where id_makanan='"+idmakanan.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    private javax.swing.JTextPane idmakanan;
    ...
    private javax.swing.JTextPane namamakanan;
